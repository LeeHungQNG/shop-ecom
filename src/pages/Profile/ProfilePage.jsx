        ...
        <WrapperContentProfile>
          <WrapperInput>
            ...
            <ButtonComponent
              ...
              size={40}
              textbutton={'Cập nhật'}
              styleTextButtton={{ color: 'rgb(26,148,255)', fontSize: '15px', fontWeight: '700px' }}
            ></ButtonComponent>
          </WrapperInput>
          <WrapperInput>
          ...
          <WrapperInput>
            ...
            {avatar && <img src={avatar} style={{ height: '60px', width: '60px', borderRadius: '50%', objectFit: 'cover' }} alt="avatar"></img>}
